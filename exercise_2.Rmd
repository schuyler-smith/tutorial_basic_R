...
```
For this reason lists are both great and dangerous. Indexing in a list gives a lot of users a lot of trouble. I will try to break it down to be as simple as possible.

It sucks, don't do it. Burn the code, put it in the trash can, and move on.
