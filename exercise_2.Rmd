...
But also, we said that each vertical vector must be the same atomic type, so let's demonstrate that. Check the `typeof(our_matrix)` before and after entering this into the console.
```{r}
our_matrix[,1] <- letters[1:3]
```
